odoo.define('8x8.systray.MessagingMenu', function (require) {
"use strict";
...
var MessagingMenu = Widget.extend({
    name: 'messaging_menu',
    template:'8x8.systray.MessagingMenu',
    events: {
    ...
    _renderPreviews: function (previews) {
        this._$previews.html(QWeb.render('8x8.systray.MessagingMenu.Previews', {
            previews: previews,
        }));
    },
    /**
